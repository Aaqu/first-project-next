...
export type GetProductListQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string, slug: string, name: string, price: number, images: Array<{ __typename?: 'Asset', url: string }> }> };
...
export type GetProductDetailsByIdQueryVariables = Exact<{
  id?: InputMaybe<Scalars['ID']>;
}>;
...
export const GetProductDetailsByIdDocument = gql`
...
/**
 * __useGetProductDetailsByIdQuery__
 *
 * To run a query within a React component, call `useGetProductDetailsByIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProductDetailsByIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProductDetailsByIdQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetProductDetailsByIdQuery(baseOptions?: Apollo.QueryHookOptions<GetProductDetailsByIdQuery, GetProductDetailsByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductDetailsByIdQuery, GetProductDetailsByIdQueryVariables>(GetProductDetailsByIdDocument, options);
      }
export function useGetProductDetailsByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductDetailsByIdQuery, GetProductDetailsByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductDetailsByIdQuery, GetProductDetailsByIdQueryVariables>(GetProductDetailsByIdDocument, options);
        }
